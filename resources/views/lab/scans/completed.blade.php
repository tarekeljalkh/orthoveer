...
<section class="section">
    <div class="section-header">
        ...
        <h1>{{ trans('messages.completed_scans') }}</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="{{ route('lab.dashboard') }}">{{ trans('messages.dashboard') }}</a></div>
            <div class="breadcrumb-item"><a href="#">{{ trans('messages.completed_scans') }}</a></div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table id="completed" class="display nowrap" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ trans('messages.completed_date') }}</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $scan->latestStatus->created_at->format('d/m/Y') }}</td>
                                    <td>
                                        <div class="badge
...
<script>
    $(document).ready(function () {
        ...
        $('#completed tbody').on('change', 'input[type="checkbox"]', function() {
            if (!this.checked) {
