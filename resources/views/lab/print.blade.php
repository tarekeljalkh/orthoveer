...
<body>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-lg-8">
                                                ...
                                                <p class="section-lead">The payment method that we provide is to make
                                                    it easier for you to pay invoices.</p>
                                                <div class="images">
    ...
    <!-- General JS Scripts -->
    <script src="{{ public_path('assets/modules/jquery.min.js') }}"></script>
    <script src="{{ public_path('assets/modules/popper.js') }}"></script>
    <script src="{{ public_path('assets/modules/tooltip.js') }}"></script>
    <script src="{{ public_path('assets/modules/bootstrap/js/bootstrap.min.js') }}"></script>
    <script src="{{ public_path('assets/modules/nicescroll/jquery.nicescroll.min.js') }}"></script>
    <script src="{{ public_path('assets/modules/moment.min.js') }}"></script>
