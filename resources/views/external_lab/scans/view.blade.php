    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('external_lab.scans.index') }}">Scans</a></div>
        ...
        <div class="section-body">
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="form-group row align-items-center">
                                @if ($scan->stl_upper || $scan->stl_lower)
                                    <a href="{{ route('external_lab.scans.downloadStl', $scan->id) }}"
                ...
                <div class="col-4 col-md-4 col-lg-4">
                    ...
                    {{-- Comple Scan Section --}}
                    @if (!empty($scan->lab_file))
                        <!-- File exists, provide download link -->
                        <div class="card">
                            <div class="card-header">
                                <h4>Download Completed Scan</h4>
                            </div>
                            <div class="card-body">
                                <a href="{{ asset($scan->lab_file) }}" class="btn btn-primary">Download File</a>
                            </div>
                        </div>
                    @else
                        <!-- File does not exist, show upload form -->
                        <div class="card">
                            <div class="card-header">
                                <h4>Upload 3D And Complete Scan</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('external_lab.scans.complete', $scan->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('post')
                                    <div class="form-group">
