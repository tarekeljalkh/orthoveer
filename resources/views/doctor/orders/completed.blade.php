                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>{{ trans('messages.completed_orders') }}</h4>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">

                                <table id="completedOrders" class="display nowrap" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @isset($order->latestStatus)
                                                        <div class="badge badge-success">{{ $order->latestStatus->status }}</div>
                                                    @endisset
                                                </td>
                                                <td>
                                                    @isset($order->latestStatus)
