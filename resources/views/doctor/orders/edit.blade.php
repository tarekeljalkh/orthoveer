                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="date" name="due_date" class="form-control" value="{{ $order->due_date instanceof \DateTime ? $order->due_date->format('Y-m-d') : \Carbon\Carbon::parse($order->due_date)->format('Y-m-d') }}" min="{{ now()->toDateString() }}">
                                </div>
                    ...
                    <div class="card">
                                    ...
                                    <div class="activities">
                                        ...
                                        <div class="activity">
                                            ...
                                            <div class="activity-detail" style="word-break: break-word">
                                                <div class="mb-2">
                                                    <span class="text-job text-primary">{{ $status->updatedBy->role ?? 'User' }}, {{ $status->updatedBy->last_name }}, {{ $status->updatedBy->first_name }},</span>
                        ...
                        <div class="card-footer text-right">
                            <div class="form-group col-md-8 col-8">
                                <input class="form-control" type="text" name="note" placeholder="Enter New Note" required>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-12">
                                    ...
                                    <div style="display: flex; align-items: center; flex-wrap: nowrap; overflow-x: auto; gap: 20px;">
                                        ...
                                        <a href="{{ asset($filePath) }}" download style="flex-shrink: 0; display: inline-flex; align-items: center;"></a>
                                        @else
                                ...
                                <div class="form-group col-12 text-right">
                                    <button type="button" class="btn btn-danger" id="clearFilesButton">Clear Files</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <div id="stl_upper" style="width:300px; height:300px; margin:0 auto;{{ !$order->stl_upper ? ' display:none;' : '' }}"></div>
                                    <input type="file" name="stl_upper" class="form-control">
                                </div>
                                <div class="form-group col-md-6 col-12">
                                    <label>{{ trans('messages.stl_lower') }} <i class="fas fa-arrow-down"></i></label>
                                    <div id="stl_lower" style="width:300px; height:300px; margin:0 auto;{{ !$order->stl_lower ? ' display:none;' : '' }}"></div>
                                    <input type="file" name="stl_lower" class="form-control">
                                </div>
                                <div class="form-group col-12 text-right">
                                    <button type="button" class="btn btn-danger" id="clearSTLFilesButton">Clear STL Files</button>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer text-right">
            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6 col-12">
                                    <label>{{ trans('messages.due_date') }}</label>
                                    <input type="date" name="due_date" class="form-control" value="{{ $order->due_date instanceof \DateTime ? $order->due_date->format('Y-m-d') : \Carbon\Carbon::parse($order->due_date)->format('Y-m-d') }}" min="{{ now()->toDateString() }}" disabled>
                                </div>
                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-footer text-right">
                            <div class="form-group col-md-8 col-8">
                                <input class="form-control" type="text" name="note" placeholder="Enter New Note" required hidden>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    <input type="file" name="pdf[]" id="pdfInput" class="form-control" multiple hidden>
                                </div>
                                <div class="form-group col-12 text-right">
                                    <button type="button" class="btn btn-danger" id="clearFilesButton">Clear Files</button>
                                </div>
