                            ...
                            <div class="row">
                                <div class="form-group col-md-12 col-12">
                                    ...
                                    <select class="form-control select2" id="lab_id" name="lab_id">
                                        @foreach ($labs as $lab)
                                            <option value="{{ $lab->id }}">{{ $lab->first_name }} {{ $lab->last_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-12 col-12">
                                    ...
                                    <select class="form-control select2" id="second_lab_id" name="second_lab_id">
                                        ...
                                        @foreach ($second_labs as $second_lab)
                                            <option value="{{ $second_lab->id }}">{{ $second_lab->first_name }} {{ $second_lab->last_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-12 col-12">
                                    ...
                                    <select class="form-control select2" id="external_lab_id" name="external_lab_id">
                                        ...
                                        @foreach ($external_labs as $external_lab)
                                            <option value="{{ $external_lab->id }}">{{ $external_lab->first_name }} {{ $external_lab->last_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12 col-12">
                                    ...
                                    <div id="doctor-prices">
                                        <div class="row mb-2">
                                            <div class="col-md-6">
                                                <select class="form-control select2" name="doctor_prices[0][doctor_id]">
                                            ...
                                            <div class="col-md-6">
                                                <input type="number" name="doctor_prices[0][price]" class="form-control" placeholder="Price">
                                            </div>
                                        </div>
                                    </div>
