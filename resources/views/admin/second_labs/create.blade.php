    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="#">Add New Second Lab</a></div>
            </div>
        </div>
        ...
        <div class="section-body">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <form action="{{ route('admin.second_labs.store') }}" method="post" class="needs-validation"
