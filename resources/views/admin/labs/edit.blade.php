...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <h1>{{ trans('messages.edit') }} {{ trans('messages.lab') }}</h1>
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="#">{{ trans('messages.edit') }} {{ trans('messages.lab') }}</a></div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <form action="{{ route('admin.labs.update', $lab->id) }}" method="post" class="needs-validation"
                            ...
                            <div class="card-header">
                                <h4>{{ trans('messages.edit') }} {{ trans('messages.lab') }}</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="form-group col-md-12 col-12">
                                    ...
                                    <select class="form-control" name="verified">
                                        <option value="yes" {{ $lab->email_verified_at ? 'selected' : '' }}>{{ trans('messages.yes') }}
                                        </option>
                                        <option value="no" {{ !$lab->email_verified_at ? 'selected' : '' }}>{{ trans('messages.no') }}
                                        </option>
                                    </select>
                                </div>
                            </div>
