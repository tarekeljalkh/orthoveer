...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <h1>{{ trans('messages.add_new_external_lab') }}</h1>
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="#">{{ trans('messages.add_new_external_lab') }}</a></div>
            </div>
        </div>
        ...
        <div class="section-body">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <form action="{{ route('admin.external_labs.store') }}" method="post" class="needs-validation"
                            novalidate="" enctype="multipart/form-data">
                            @csrf

                            <div class="card-header">
                                <h4>{{ trans('messages.add_new_external_lab') }}</h4>
                            </div>
                            <div class="card-body">
